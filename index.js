...
function getArtistByIndex(arr, desiredIndex) {
  return `the artist at index ${desiredIndex} is ${arr[desiredIndex]['name']}`;
}
...
function removeArtist(arr, desiredIndex) {
...
function addArtist(arr) {
  arr.push({
    ...
    bio: 'Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quisquam, reiciendis recusandae. Quibusdam suscipit nesciunt iure harum quaerat tempore aspernatur modi praesentium accusantium ducimus dolorem, eum dignissimos deleniti laudantium sapiente blanditiis?',
  });
  return arr;
}
...
console.log('artists with over 100 works: ' + lotsOfArt(artists));
